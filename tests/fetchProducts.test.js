...
test('Teste se fetchProducts é uma função2', () => {
...
// test('Teste se, ao chamar a função fetchProducts sem argumento, retorna um erro com a mensagem: You must provide an url', () => {
