...
describe('3 - Teste a função saveCartItems', () => {
  ...
  it(`Teste se a função retorna 'mensagem espera  ao executar saveCartItems com o argumento inválido`, () => {
    expect(saveCartItems('asdas')).toEqual(new Error('You must provide a valid item'));
  });
});
