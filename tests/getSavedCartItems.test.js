...
describe('4 - Teste a função getSavedCartItems: ', () => {
  ...
  test('Teste se quando chamar a função getSavedCartItems o retorno é igual a localStorageSimulator: ', () => {
    expect(getSavedCartItems()).toEqual(localStorageSimulator);
  });
});
